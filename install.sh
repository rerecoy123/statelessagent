...
if echo "$PATH" | tr ':' '\n' | grep -qx "$INSTALL_DIR"; then
  ...
  echo ""
  echo "  IMPORTANT: For this to take effect, either:"
  echo "  - Close this terminal and open a new one, OR"
  echo "  - Run this command: source $RC_FILE"
fi
...
if command -v ollama >/dev/null 2>&1; then
  ...
  echo ""
  echo "  SAME needs Ollama to work. It's free and takes 1 minute:"
  echo ""
  echo "  1. Go to: https://ollama.ai"
  echo "  2. Click Download"
  echo "  3. Open the app once to complete setup"
  echo ""
  echo "  Then come back here and you're ready!"
fi
...
echo ""
echo "  3. Initialize SAME:"
echo "     same init"
echo ""
echo "  That's it! SAME will start learning your project."
echo ""
