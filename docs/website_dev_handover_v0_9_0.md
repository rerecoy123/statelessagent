...
- key write paths and cleanup paths (config/registry/handoff/index stats/tutorial+demo scaffolding/seed config rewrites+rollback cleanup/verbose logs) now surface failures instead of silently skipping them
